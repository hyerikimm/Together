...
import com.hr.together.member.controlller.MemberController;
import com.hr.together.member.model.vo.KakaoUserInfo;
...
public class KakaoAPI {
    ...
    public String getAccessToken (String authorize_code) {
        ...
        try {
            ...
            sb.append("&redirect_uri=http://localhost:8787/together/loginJoin/kakao");
    ...
    /**
     * 카카오 로그아웃(이 서비스에서만 로그아웃 -> 웹브라우저에 카카오계정 세션은 만료되지 않고, 로그아웃 호출한 앱의 토큰만 만료
     * @param accessToken
     */
